...
def can_update_using_update_method
  ...
  awesome_flick = Movie.find_by(title: "Wat?")
  awesome_flick.update(title: "Wat, huh?")
end
...
def can_destroy_a_single_item
  ...
  that_one_movie = Movie.find_by(title: "That One Where the Guy Kicks Another Guy Once")
  that_one_movie.destroy 
end
